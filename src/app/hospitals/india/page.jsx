...
const HOSPITALS = [
  ...
  },
  {
    ...
    established: '1956',
    mou: false,
    img: '/hospitals/aiims-delhi-all-india-institute-medical-sciences-india.jpg',
    specialties: ['Oncology', 'Neurosurgery', 'Cardiac Surgery', 'Organ Transplant', 'Orthopaedics', 'Bone Marrow Transplant'],
    highlights: [
      'India\'s premier government medical institution — ranked #1 hospital in India consistently by NIRF (National Institutional Ranking Framework)',
      'Performs 150,000+ surgeries annually including complex multi-organ transplants, pediatric cardiac surgery, and rare neurological procedures',
      'One of the world\'s largest teaching hospitals — home to India\'s most highly trained surgeons and specialists',
      'Exceptional tertiary and quaternary care at a fraction of private hospital costs — the gold standard for complex case management in South Asia',
    ],
    doctors: '3,000+ faculty specialists',
...
const STATS = [
  { value: '9+',      label: 'Partner Hospitals in India' },
