...
const TEAM = [
  {
    ...
    members: [
      ...
      {
        name: 'Dr. Faiyaz Alam',
        image: '/team/dr-faiyaz-alam.png',
        credentials: 'MBBS, DMRD',
        title: 'Consultant Radiologist',
        ghcRole: 'Expert Radiology Review & Second Opinions for International Patients',
        organization: 'Kolkata, India',
        previousOrg: 'Jawaharlal Nehru Medical College, Aligarh Muslim University',
        country: 'India',
        flag: 'in',
        degree: 'MBBS, DMRD — Jawaharlal Nehru Medical College, AMU',
        specialty: 'Diagnostic Imaging & Radiological Interpretation',
        expertise: [
        ...
        languages: 'English, Hindi, Urdu',
        highlight: 'Provides expert radiology review and second opinions for international patients, supporting accurate diagnosis and treatment planning before and during their medical journey.',
        accent: 'sky',
      ...
      // ── 10. Dr. Zeba I. Murtaza ──────────────────────────────────────────────
      {
        ...
        image: '',
        credentials: 'MD (OB/GYN), ECFMG Certified',
        title: 'Senior Obstetrician & Gynecologist | Women\'s Health Specialist',
        ghcRole: 'Expert Consultations, Second Opinions & Fertility Evaluation for International Patients',
        organization: 'City of Hope — Oncology Clinical Research',
        previousOrg: 'Formerly: Ministry of Health, Oman | Aligarh Muslim University Graduate',
        country: 'United States',
        flag: 'us',
        degree: 'MD (OB/GYN), ECFMG Certified — Aligarh Muslim University',
        specialty: 'High-Risk Pregnancy, Infertility, Gynecological Disorders & Menopause Management',
        expertise: [
          'High-Risk Pregnancy',
          'Infertility & Fertility Evaluation',
        ...
        experience: '25+ Years',
        languages: 'English',
        highlight: '25+ years of international clinical experience across India, Oman, and the USA. ECFMG Certified. Formerly with Ministry of Health, Oman. Currently involved in oncology clinical research at City of Hope.',
        accent: 'fuchsia',
        grad: 'from-fuchsia-50 via-pink-100 to-fuchsia-100',
        patternColor: 'bg-fuchsia-200/60',
  ...
  // ── Physiotherapy ─────────────────────────────────────────────────────────
  {
    ...
    members: [
      {
        name: 'Deepesh Dwivedi',
        image: '/team/deepesh-dwivedi.png',
        credentials: 'BPT',
        title: 'Consultant Physiotherapist',
        ghcRole: 'Rehabilitation & Recovery Support for International Patients',
        organization: 'Bhopal, India',
        previousOrg: '25+ Years Clinical Experience — Musculoskeletal, Neurological & Orthopaedic Rehab',
        country: 'India',
        flag: 'in',
        degree: 'BPT (Bachelor of Physiotherapy)',
        specialty: 'Musculoskeletal, Neurological & Orthopaedic Rehabilitation',
        expertise: [
        ...
        highlight: 'Provides comprehensive physiotherapy and rehabilitation for international patients recovering from orthopaedic surgery, sports injuries, neurological disorders, and chronic pain.',
        accent: 'violet',
        grad: 'from-violet-50 via-purple-100 to-violet-100',
        patternColor: 'bg-violet-200/60',
        avatarText: 'text-violet-600',
