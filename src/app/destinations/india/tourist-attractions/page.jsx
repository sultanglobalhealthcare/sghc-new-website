...
const PRACTICAL = [
  { icon: Plane,    title: 'Flights from the U.S.', desc: 'Airlines: American, Air India, Air France, British Airways, Emirates, Etihad, Lufthansa, Qatar, Saudi, Turkish, and United offer connections to Delhi, Mumbai, Chennai, Bengaluru, and Hyderabad. U.S. East Coast to Delhi/Mumbai: 14–16 hours, typically one stop via London, Paris, Frankfurt, Dubai, Doha, Kuwait, Jeddah, or Istanbul. U.S. West Coast to Delhi/Mumbai: 15–17 hours, nonstop available on Air India and United. Typical travel time overall: 16–22 hours. Best practice: book flexible-date tickets; Sultan GHC helps plan your complete travel itinerary.' },
  ...
  { icon: Star,     title: 'English Language', desc: 'English is an official language of India and the primary language of medical practice at all partner hospitals. Consultations, consent forms, and discharge summaries are all in English. India has approximately 125 million English speakers — the second-largest English-speaking population in the world. Menus, signs, and transport in major cities are in English.' },
  { icon: Shield,   title: 'Safety', desc: 'Major Indian cities (Delhi, Mumbai, Chennai, Hyderabad, Bengaluru) are safe for medical travelers. Use Uber or Ola (both apps work throughout India) for transport. Sultan GHC arranges private airport pickup, hospital transfers, and ground transport throughout. Avoid tap water — use bottled water exclusively. Comprehensive travel insurance including medical evacuation is strongly recommended.' },
  { icon: Coffee,   title: 'Food During Recovery', desc: 'All Sultan GHC partner hospitals offer international menus — not only Indian cuisine. Dietary requirements (vegetarian, halal, low-sodium, diabetic) are accommodated on request. South Indian vegetarian food (idli, dosa, rice) is very gentle post-operatively. Your Sultan GHC coordinator advises on diet restrictions specific to your procedure.' },
  { icon: Calendar, title: 'SIM Card & Connectivity', desc: 'Buy a prepaid Airtel or Jio SIM at the airport on arrival (passport required). Affordable 5G data (₹300 ≈ $3.50/month unlimited). Hotel WiFi is generally excellent across all cities. WhatsApp works perfectly throughout India and is the preferred communication platform.' },
]
