...
const PRACTICAL = [
  { icon: Plane,    title: 'Flights from the U.S.', desc: 'Turkish Airlines operates nonstop services from JFK, EWR, IAD, ORD, MIA, LAX, SFO, and BOS. U.S. East Coast to Istanbul: 10–11 hours nonstop (New York, Washington DC, Miami, Chicago, Boston). U.S. West Coast: 14–15 hours, typically one stop. Istanbul Airport (IST) is the busiest airport in Europe. United, Delta, American, and Lufthansa/KLM also offer connections via European hubs. Best practice: book flexible-date tickets; Sultan GHC helps plan your complete travel itinerary.' },
  ...
  { icon: Star,     title: 'Language', desc: 'All JCI-accredited hospitals in Istanbul have dedicated International Patient Departments staffed by English-speaking physicians, coordinators, and patient relations staff. Medical consultations, consent forms, discharge summaries, and follow-up communications are all in English. English is widely spoken at hotels, tourist sites, and restaurants throughout Istanbul.' },
  { icon: Shield,   title: 'Safety', desc: 'Istanbul, Antalya, Izmir, and all major tourist cities are safe for international visitors. Sultan GHC arranges private airport transfers and hospital transport throughout your stay. The hospital districts (Nisantasi, Sisli, Kadikoy) are affluent, well-policed urban areas. Use BiTaksi or Uber for registered taxis. Comprehensive international travel insurance including medical evacuation is strongly recommended.' },
  { icon: Coffee,   title: 'Food During Recovery', desc: 'International cuisine is widely available — all major hospitals offer non-Turkish dietary options. Halal, vegetarian, low-sodium, and diabetic meal plans are accommodated at all partner hospitals. Turkish cuisine itself — rich in vegetables, legumes, olive oil, and grilled protein — is generally excellent for recovery. Soups (lentil, yogurt) are gentle post-operatively.' },
  { icon: Calendar, title: 'SIM Card & Connectivity', desc: 'Buy a Turkcell or Vodafone Türkiye prepaid SIM at Istanbul Airport on arrival (passport required). Fast 4G/5G data throughout Istanbul and all major cities at very affordable rates. Hotel WiFi is generally excellent. WhatsApp is the preferred communication platform in Türkiye.' },
]
