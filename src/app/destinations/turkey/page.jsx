...
export const metadata = {
  title: 'Medical Treatment in Türkiye for American Patients | Sultan GHC Destination Guide',
  description:
    "Türkiye welcomed 2 million health tourists in 2024 with $10 billion in revenue. JCI-accredited hospitals in Istanbul, 50–70% cost savings vs. U.S. prices, European-standard care, and a 10-hour direct flight from the U.S. East Coast. Sultan GHC connects American patients with the right specialist in Türkiye — free evaluation in 24 hours.",
  keywords: [
    'medical treatment Türkiye Americans',
    'medical tourism Türkiye USA',
    'JCI accredited hospitals Türkiye Istanbul',
    'Türkiye medical tourism cost savings',
    'hair transplant Türkiye USA patients',
    'dental implants Türkiye cost',
    'Istanbul hospitals international patients',
    'bariatric surgery Türkiye',
    'IVF treatment Türkiye cost',
    'Türkiye medical visa USA',
    'cosmetic surgery Türkiye Americans',
    'heart surgery Türkiye cost',
    'Türkiye healthcare quality international',
    'Sultan GHC Türkiye',
    'affordable surgery Türkiye Americans',
  ],
  openGraph: {
    title: 'Medical Treatment in Türkiye | Sultan GHC Destination Guide',
    description:
      "2 million health tourists, $10 billion in revenue, 40+ JCI-accredited hospitals. Türkiye — Europe's leading medical tourism hub — is 10 hours from the U.S. East Coast. Sultan GHC matches U.S. patients to the right Istanbul specialist — free in 24 hours.",
    url: 'https://www.sultanghc.com/destinations/turkey',
    siteName: 'Sultan Global Health Care',
    type: 'website',
    images: [{ url: 'https://www.sultanghc.com/api/og?title=Medical+Treatment+in+Türkiye&desc=Istanbul%27s+JCI-accredited+hospitals.+European+standards+at+60-80%25+lower+than+U.S.+costs.&cat=Destination+Guide', width: 1200, height: 630, alt: 'Medical Treatment in Türkiye — Sultan GHC' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Medical Treatment in Türkiye for Americans | Sultan GHC',
    description: '2M health tourists, $10B revenue, JCI hospitals. Türkiye treated more medical tourists than any European country in 2024.',
  },
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Is medical treatment in Türkiye safe for American patients?',
      acceptedAnswer: { '@type': 'Answer', text: "Yes. Türkiye has 40+ JCI-accredited hospitals — the same international quality standard used to certify leading U.S. hospitals — with 25 of those located in Istanbul. Turkish hospitals operate under EU-aligned healthcare regulations and employ physicians with fellowship training from Germany, France, the UK, and the United States. Sultan GHC recommends only internationally accredited hospitals that meet rigorous quality benchmarks." },
    },
    {
      '@type': 'Question',
      name: 'How far is Türkiye from the United States?',
      acceptedAnswer: { '@type': 'Answer', text: "Istanbul is approximately 10–11 hours from the U.S. East Coast by direct flight. Turkish Airlines operates nonstop services from New York (JFK), Chicago (ORD), Washington D.C. (IAD), Los Angeles (LAX), and Miami (MIA). This makes Türkiye significantly more accessible than many other medical tourism destinations — a shorter journey than flying to India or Thailand." },
    },
    {
      '@type': 'Question',
      name: 'Do I need a visa to travel to Türkiye for medical treatment?',
    ...
    {
      '@type': 'Question',
      name: 'Why is Türkiye the number one destination for hair transplant surgery?',
      acceptedAnswer: { '@type': 'Answer', text: "Türkiye performs more hair transplant procedures than any other country in the world — an estimated 500,000+ per year. This volume has produced a concentration of specialist surgeons, advanced FUE and DHI techniques, and highly competitive pricing that no other destination matches. Istanbul alone has hundreds of specialist hair transplant clinics, many operating inside JCI-accredited hospital groups. Costs in Türkiye run 60–80% below U.S. prices for the same procedure." },
    },
    {
      '@type': 'Question',
      name: 'How many international patients travel to Türkiye each year?',
      acceptedAnswer: { '@type': 'Answer', text: "Türkiye welcomed approximately 2 million international health tourists in 2024, generating $10 billion in health tourism revenue — according to data published by the Turkish Ministry of Health (New Health Media, February 2025). In 2023, Türkiye hosted 1,538,643 health tourists generating over $3 billion in revenue (TurkStat). Türkiye attracts patients from more than 120 countries and is Europe's leading medical tourism destination by volume." },
    },
  ],
}
...
const STATS = [
  { value: '2 Million',  label: 'International health tourists welcomed by Türkiye in 2024',   source: 'Turkish Ministry of Health, Feb 2025' },
  { value: '$10B',       label: 'Health tourism revenue generated by Türkiye in 2024',          source: 'New Health Media, Feb 2025' },
...
const REASONS = [
  {
    ...
    body: "Türkiye's hospitals operate under EU-aligned healthcare regulations and hold JCI accreditation — the same international standard used to certify leading U.S. hospitals. With 40+ JCI-accredited institutions (25 in Istanbul alone), Türkiye offers the highest concentration of internationally certified hospitals of any country in its region. Accreditation is publicly verifiable at jointcommissioninternational.org.",
  ...
  },
  {
    ...
    body: "Major hospitals in Türkiye — particularly in Istanbul — are equipped with the same generation of diagnostic and surgical technology found in leading American medical centers: da Vinci robotic surgery systems, PET-CT scanners, CyberKnife and TrueBeam radiosurgery, hybrid catheterization labs, and implants from Medtronic, Johnson & Johnson, Stryker, and Zimmer Biomet. New flagship facilities such as Başakşehir Çam and Sakura City Hospital represent some of the most advanced healthcare infrastructure in Europe.",
  ...
  },
  {
    ...
    body: "Türkiye performs more hair transplants than any other country globally — over 500,000 per year. It is Europe's leading destination for bariatric surgery and among the top destinations worldwide for dental implants, rhinoplasty, and IVF treatment. This volume is not incidental — it means Turkish surgeons in these specialties have extraordinarily deep procedural experience, producing consistently high patient satisfaction rates and outcome data.",
...
const CITIES = [
  ...
  },
  {
    ...
    desc: "As Türkiye's capital, Ankara is home to major government-affiliated teaching hospitals and research centers alongside leading private hospital groups. The city is a strong destination for oncology, haematology, organ transplantation, and neurology — particularly for patients who prefer a quieter environment than Istanbul for their recovery, with lower accommodation costs and shorter in-hospital waiting times.",
...
const PRACTICAL = [
  ...
  },
  {
    ...
    points: [
      ...
      'Türkiye is a year-round medical destination — winters in Istanbul are cool but manageable',
...
const FAQS = [
  ...
  {
    q: 'Why is Türkiye the global number one for hair transplant surgery?',
    a: "Türkiye performs more hair transplant procedures than any other country — an estimated 500,000+ per year. This volume has produced an unmatched concentration of specialist surgeons, advanced FUE and DHI techniques, and pricing that is 60–80% below U.S. costs for the same procedure. Istanbul alone has hundreds of specialist hair transplant clinics, many operating within internationally accredited hospital groups.",
  },
  {
    q: 'How many international patients travel to Türkiye each year?',
    a: "Türkiye welcomed approximately 2 million international health tourists in 2024, generating $10 billion in health tourism revenue, according to the Turkish Ministry of Health (New Health Media, February 2025). In 2023, Türkiye hosted 1,538,643 health tourists generating over $3 billion (TurkStat / EIN Presswire). Türkiye attracts patients from 120+ countries and is Europe's leading medical tourism destination by volume.",
  },
]

// ─── Page ─────────────────────────────────────────────────────────────────────

export default function TürkiyeDestinationPage() {
  return (
    <>
      ...
      <section className="bg-[#EEF4FF] border-b border-[#d9e6ff]">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14 sm:py-20">
          ...
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-[12px] text-gray-400 mb-8">
            ...
            <ChevronRight size={12} />
            <span className="text-primary font-medium">Türkiye</span>
          </nav>
          ...
          <div className="flex flex-col lg:flex-row gap-14 items-center">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-500 leading-relaxed mb-5 max-w-xl">
                Türkiye is Europe&rsquo;s leading medical tourism destination — not because of low costs alone,
              ...
              <p className="text-gray-500 leading-relaxed mb-8 max-w-xl">
                Sultan GHC connects U.S. patients with the right hospital and specialist in Türkiye —
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  Get My Free Türkiye Evaluation
                  <ArrowRight size={16} />
                </Link>
                <a
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14">
          <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-widest text-center mb-10">
            By the Numbers — Türkiye&rsquo;s Medical Tourism Credentials
          </p>
            ...
            {[
              {
                ...
                quote: '"With approximately 2 million health tourists and over $10 billion in revenue, Türkiye has once again proven its leadership in the global health tourism market."',
                href: 'https://www.newhealth.media/en/blog/turkeys-2024-health-tourism-data',
              },
              {
                outlet: 'EIN Presswire / Türkiye Medicals',
                date: 'September 20, 2024',
                quote: '"Türkiye has established itself as a premier destination for health tourism, drawing international attention and positioning itself as a vital player in the global healthcare landscape."',
              ...
              },
              {
                ...
                quote: '"42 JCI-accredited hospitals and mandatory registration of every overseas case on the HealthTürkiye portal form the core growth engine for Türkiye\'s medical tourism market."',
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-gray-500 leading-relaxed">
            Türkiye&rsquo;s standing as Europe&rsquo;s top medical tourism destination is built on verifiable
      ...
      <section className="bg-[#F5F7FA] border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <span className="inline-block text-[11px] font-semibold text-primary uppercase tracking-widest bg-primary/10 px-3 py-1.5 rounded-full mb-4">
              Türkiye&rsquo;s Medical Cities
            </span>
            <h2 className="text-2xl sm:text-4xl font-semibold text-gray-900 mb-4">
              Five Cities. Each with a Distinct Medical Strength.
            </h2>
            <p className="text-gray-500 leading-relaxed">
              Türkiye&rsquo;s medical excellence spans five cities — each with its own specialty profile.
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-4xl font-semibold text-gray-900 mb-4">
            What You Pay in the U.S. vs. What You Pay in Türkiye
          </h2>
          <p className="text-gray-500 leading-relaxed">
            Representative cost ranges at JCI-accredited hospitals in Türkiye.
        ...
        <div className="rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
          <div className="grid grid-cols-4 bg-gray-900 text-white text-[11px] font-semibold uppercase tracking-widest">
            ...
            <div className="px-5 py-4 text-center border-l border-white/10">Türkiye (JCI Hospital)</div>
          </div>
      ...
      <section className="bg-[#EEF4FF] border-y border-[#d9e6ff]">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2 className="text-2xl sm:text-4xl font-semibold text-gray-900 mb-4">
              What It Is Actually Like to Seek Treatment in Türkiye
            </h2>
            <p className="text-gray-500 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14">
        <div className="bg-gray-900 rounded-2xl p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          <div className="flex-1">
            <p className="text-[11px] font-semibold text-primary uppercase tracking-widest mb-2">Government of Türkiye Initiative</p>
            <h3 className="text-lg font-semibold text-white mb-2">The HealthT&uuml;rkiye Platform</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Türkiye&rsquo;s Ministry of Health has launched HealthT&uuml;rkiye — a mandatory national registry
              ...
              at the highest level of Türkiye&rsquo;s government.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-3">
              Questions Specific to Treatment in Türkiye
            </h2>
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { href: '/hospitals/turkey',              icon: Shield,       label: 'Partner Hospitals in Türkiye' },
      ...
      <section className="bg-[#EEF4FF] border-t border-[#d9e6ff]">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 text-center">
          ...
          <h2 className="text-2xl sm:text-4xl font-semibold text-gray-900 mb-4 leading-tight">
            Ready to Explore Treatment in Türkiye?
          </h2>
          <p className="text-gray-500 text-lg leading-relaxed max-w-2xl mx-auto mb-8">
            ...
            opinion, matched hospital recommendation in Türkiye, and a transparent cost estimate.
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            >
              Get My Free Türkiye Medical Evaluation
              <ArrowRight size={16} />
            </Link>
            <a
